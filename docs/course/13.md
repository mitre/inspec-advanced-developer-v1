...
#### 13.1.4. test/unit/resources/nginx_test.rb
```ruby
# encoding: utf-8
# author: Aaron Lippold, lippold@gmail.com
...
### 13.2 IPv6 resource
#### 13.2.1. docs/resources/ip6tables.md.erb
```ruby
---
...
#### 13.2.2. lib/inspec/resources.rb
```ruby
...
#### 13.2.3. lib/inspec/resources/ip6tables.rb
```ruby
...
#### 13.2.4. test/integration/default/controls/ip6tables_spec.rb
```ruby
case os[:family]
...
#### 13.2.5. test/unit/resources/ip6tables_test.rb
```ruby
require "helper"
require "inspec/resource"
require "inspec/resources/ip6tables"
