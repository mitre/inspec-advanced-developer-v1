...
## 15. Pushing your resource up to InSpec walkthrough
As an example we will go through a few custom resources that were built and approved.

### 15.1. IPv6 resource
#### 15.1.1. docs/resources/ip6tables.md.erb
```ruby
---
...
#### 15.1.2. lib/inspec/resources.rb
```ruby
...
#### 15.1.3. lib/inspec/resources/ip6tables.rb
```ruby
...
#### 15.1.4. test/cookbooks/os_prepare/recipes/default.rb 
```ruby
include_recipe("os_prepare::package")
include_recipe("os_prepare::registry_key")
include_recipe("os_prepare::iis")

include_recipe("os_prepare::iptables") # This activates the code in section 15.1.5 below

include_recipe("os_prepare::x509")
include_recipe("os_prepare::dh_params")
```

#### 15.1.5. test/cookbooks/os_prepare/recipes/iptables.rb 
```ruby
...
#### 15.1.6. test/helpers/mock_loader.rb
```ruby
      # iptables
...
#### 15.1.7. test/integration/default/controls/ip6tables_spec.rb
```ruby
case os[:family]
...
#### 15.1.8. test/unit/mock/cmd/ip6tables-s
```bash
-P INPUT DROP
-P FORWARD DROP
-P OUTPUT ACCEPT
...
#### 15.1.9. test/unit/resources/ip6tables_test.rb
```ruby
require "helper"
...
### 15.2. NGINX resource
#### 15.2.1. docs/resources/nginx.md.erb
```ruby
---
...
#### 15.2.4. test/unit/resources/nginx_test.rb
```ruby
# encoding: utf-8
# author: Aaron Lippold, lippold@gmail.com
...
#### 15.3.1. PAM resource currently open PR
...
#### 15.3.2. Customizing an already existing resource (windows registry)
